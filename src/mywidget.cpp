...
void myWidget::show_parameter(){
    ...
    if(conflag == 0)
    {
        get_eng_ti_dis(num_mon[0]);          //FEF0
        get_speed_data(num_mon[1]);          //FDF0
...
//割台高度检测值,2019.4.3在18FF2815的6-7字节
void myWidget::getCutHeight(int array[8])
{
    CutterHeightvalue = array[6] + array[7]*256;

    if(array[6] == (qreal)(0xff) && array[7] == (qreal)(0xff))
                CutterHeightvalue = 0;
...
/*
2019.4.3更新
将割宽和行驶速度放到一个ID 18FF2913
*/
/*
 2019.2.27修改
割宽：原来为从18FF2413的0,1两个字节获得左右割宽值
应东南大学要求，现在改为从18FF2913的2345这4个字节获得
*/
//割宽
